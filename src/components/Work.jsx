...
import workphoto from "../assets/workImg1.png";
import workimage from "../assets/workImg2.png";
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://extraordinary-bienenstitch-c97356.netlify.app">
                  <button className="text-center rounded-l px-4 py-3 m-2 text-gray-700 font-bold text-lg bg-white">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/fanuelstephen/coffee-website">
                  <button className="text-center rounded-l px-4 py-3 m-2 text-gray-700 font-bold text-lg bg-white">
                    Code
                  </button>
                </a>
